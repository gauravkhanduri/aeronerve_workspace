...
class ReactiveNavNode(Node):
    ...
    def __init__(self):
        ...
        # ---- Parameters ----
        self.declare_parameter("slow_distance", 8.0)  # meters — start slowing here
        self.declare_parameter("stop_distance", 4.0)  # meters — full stop below this
        ...
        self.declare_parameter("cruise_speed", 4.0)  # m/s — max speed toward goal
