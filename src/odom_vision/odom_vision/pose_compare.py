...
class PoseCompare(Node):
    def __init__(self):
        ...
        self.get_logger().info('Comparing: /mavros/vision_pose/pose vs /mavros/local_position/pose')
        self.get_logger().info('=' * 60)
    ...
    def compare(self):
        ...
        self.get_logger().info(f'DIFFERENCE:  dX={dx:+7.3f} dY={dy:+7.3f} dZ={dz:+7.3f}  |d|={pos_diff:.4f}m')
